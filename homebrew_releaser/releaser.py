...
# Required GitHub Action env variables
...
# Optional GitHub Action env variable
...
def run_github_action():
    ...
    logging.info(f'Generating Homebrew formula for {REPO}...')
...
def check_required_env_variables():
    ...
    for env_variable in required_env_variables:
        if not env_variable:
            raise SystemExit(
                'You must provide all necessary environment variables. Please reference the documentation.'
            )
...
def generate_formula(username, repo_name, version, repository, checksum, install, tar_url, test):
