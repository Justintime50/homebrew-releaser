...
{matrix_entry}
            ...
            if darwin_amd64:
                final_matrix_output += f'{darwin_amd64}\n\n'
...
{matrix_entry}
            ...
            if darwin_arm64:
                final_matrix_output += f'{darwin_arm64}\n\n'
...
{matrix_entry}
            ...
            if linux_amd64:
                final_matrix_output += f'{linux_amd64}\n\n'
...
{matrix_entry}
            ...
            if linux_arm64:
                final_matrix_output += f'{linux_arm64}\n\n'

        if not matrix:
            autogenerate_tar_checksum = checksums[0][repository['name']]  # Autogenerated URL is the first one
...
{auto_generate_archive_installer if not matrix else ""}
{final_matrix_output}
{depends_on_content}
  def install
    {install.strip()}
