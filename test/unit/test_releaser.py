...
# TODO: Figure out how to mock GITHUB_REPOSITORY for every test
@mock.patch('homebrew_releaser.releaser.GITHUB_REPOSITORY', 'Justintime50/homebrew-releaser')
...
def test_generate_formula():
    ...
    version = 'v0.1.0'
    repository = {
        'description': 'A tool to release scripts, binaries, and executables directly to Homebrew via GitHub Actions.',
        'license': {
            'spdx_id': 'MIT'
        }
    }
...
class HomebrewReleaser < Formula
  desc "A tool to release scripts, binaries, and executables directly to Homebr"
